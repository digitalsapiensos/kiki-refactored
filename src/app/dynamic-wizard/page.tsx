/**
 * Wizard que lee system prompts dinámicamente desde archivos markdown
 * Single source of truth - editas el .md, se actualiza automáticamente
 */
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-mono">Cargando system prompt desde archivo...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center p-8">
          <p className="font-mono text-red-600 mb-4">Error cargando el prompt del paso {currentStep}</p>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-mono font-bold">Mi Proyecto - Dynamic Prompts</h1>
            </div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {Object.keys(completedSteps).length > 0 && (
          <div className="mt-8 p-6 bg-green-100 border-2 border-green-500">
            <h3 className="font-mono font-bold text-green-800 mb-4 flex items-center gap-2">
              🎯 Progreso del Proyecto
              <span className="text-sm text-green-600">
                (Prompts cargados dinámicamente desde archivos)
              </span>
            </h3>
        ...
        {Object.keys(completedSteps).length === 5 && (
          <div className="mt-8 p-8 bg-yellow-400 border-2 border-black text-center">
            ...
            <p className="font-mono mb-6">
              Has completado los 5 pasos usando system prompts dinámicos. 
              Tu proyecto está listo para development.
            </p>
            <Button className="bg-green-500 text-white border-2 border-black font-mono">
              Ver Dashboard del Proyecto
            </Button>
          </div>
        )}
      </div>
